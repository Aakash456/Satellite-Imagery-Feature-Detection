...
_df = pd.read_csv('/Users/sky/Downloads/train_wkt_v4.csv',
...
_df1 = pd.read_csv('/Users/sky/Downloads/grid_sizes.csv',
                   names=['ImageId', 'Xmax', 'Ymin'], skiprows=1)

# sample_submission.csv is the file for submission
_df2 = pd.read_csv('/Users/sky/Downloads/sample_submission.csv',
                   names=['ImageId', 'ClassId', 'MultipolygonWKT'], skiprows=1)
...
class ImageData():
    ...
    def get_image_path(self):
        ...
        '''
        return {
            '3': '{}/three_band/{}.tif'.format('/Users/sky/Downloads', self.image_id),
            'A': '{}/sixteen_band/{}_A.tif'.format('/Users/sky/Downloads', self.image_id),
            'M': '{}/sixteen_band/{}_M.tif'.format('/Users/sky/Downloads', self.image_id),
            'P': '{}/sixteen_band/{}_P.tif'.format('/Users/sky/Downloads', self.image_id)
        }
    ...
    def image_stack(self):
        ...
        warp_matrix_a = np.load(
            '/Users/sky/Downloads/image_alignment/{}_warp_matrix_a.npz'.format(self.image_id)
        )
        warp_matrix_m = np.load(
            '/Users/sky/Downloads/image_alignment/{}_warp_matrix_m.npz'.format(self.image_id)
        )
